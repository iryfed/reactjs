...
import styles from './controlcommentstablet.scss';

export function ControlCommentsTablet() {
  return (
    <button className={styles.controlComments}>
      <svg className={styles.commentIcon} viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg">
